...
client.user.setGame(`Tuve Server`,"http://twitch.tv/Death Shop")
            ...
            if(command == ".") {
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    ...
                    if(!args) {
                        ...
                        message.channel.send(`**هل \`${args}\`**`).then(m => {
                            m.react("✅")
                            .then(() => m.react("❌"));
            ...
            if(command == "bco") {
                if(!message.member.hasPermission("ADMINISTRATOR")) {
                    ...
                    if(!args) {
                        ...
                        message.channel.send(`**ه: \`${args}\`**`).then(m => {
                            m.react("✅")
                            .then(() => m.react("❌"));
                        ...
                        no.on("collect", v => {
                            m.delete();
                            message.channel.send("**B.**").then(msg => msg.delete(3000));
                        });
...
client.on("message", async message => {
    if(message.content.startsWith('.')) {
        let help = new Discord.RichEmbed()
			...
			اطلق من ينقط [user] 
            **`);
            message.channel.sendEmbed(.); // رابط السيرفر يعود الى سيرفر CODES .
    }
});
